...
export class Navbar extends Component {
    render() {
        return (
            <>
                {/*bg-white/80*/}
                <header className="sticky bg-gray-400 inset-0 z-50 border-b border-slate-100  backdrop-blur-lg rounded">
                    <nav
                        ...
                        <div className="hidden items-center justify-center gap-6 md:flex mr-8">
                            <a href="#" className="rounded-md bg-gradient-to-br from-blue-600 to-emerald-400 px-3 py-1.5 font-dm
                               text-sm font-medium text-white shadow-md shadow-blue-400/50 transition-transform duration-200
                               ease-in-out hover:scale-[1.03]">
                             <Link to="/login">Login</Link>
                        </a>
                            <a href="#"
                               className="rounded-md bg-gradient-to-br from-blue-600 to-emerald-400 px-3 py-1.5 font-dm
                               text-sm font-medium text-white shadow-md shadow-blue-400/50 transition-transform duration-200
                               ease-in-out hover:scale-[1.03]">
